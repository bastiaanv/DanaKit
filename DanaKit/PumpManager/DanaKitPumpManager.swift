...
private enum ConnectionResultShort {
    case success
    case failure
}
...
extension DanaKitPumpManager: PumpManager {
    ...
    private func syncHistory() async -> [NewPumpEvent] {
        ...
        do {
            ...
            let fetchHistoryPacket = generatePacketHistoryAll(options: PacketHistoryBase(from: state.lastStatusDate, usingUtc: state.usingUtc))
