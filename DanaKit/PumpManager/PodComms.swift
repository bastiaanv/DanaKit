...
protocol PodCommsDelegate: DanaKitConnectionDelegate {
...
public class PodComms: CustomDebugStringConvertible {
    ...
    public func connectToNewPod(_ completion: @escaping (Result<DanaKit, Error>) -> Void) {
...
// MARK: - DanaKitConnectionDelegate

extension PodComms: DanaKitConnectionDelegate {
