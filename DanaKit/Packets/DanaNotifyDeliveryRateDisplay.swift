...
let CommandNotifyDeliveryRateDisplay: UInt16 = (UInt16(DanaPacketType.TYPE_RESPONSE & 0xff) << 8) + UInt16(DanaPacketType.OPCODE_NOTIFY__DELIVERY_RATE_DISPLAY & 0xff)
