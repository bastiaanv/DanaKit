class DanaKitEncryption {
    ...
    let secondLvlEncryptionLookup: [UInt8] = [
        ...
        
    ]
    ...
    let secondLvlEncryptionLookupShort: [UInt8] = [
        0x63, 0x7C, 0x77, 0x7B, 0xF2, 0x6B, 0x6F, 0xC5, 0x30, 0x01, 0x67, 0x2B, 0xFE, 0xD7, 0xAB, 0x76, 0x6C, 0x70, 0x48, 0x50,
        0xFD,
        0xED, 0xB9, 0xDA, 0x5E, 0x15,
        0x46, 0x57, 0xA7, 0x8D, 0x9D, 0x84, 0xB7, 0xFD, 0x93, 0x26, 0x36, 0x3F, 0xF7, 0xCC, 0x34, 0xA5, 0xE5, 0xF1, 0x71, 0xD8,
        0x31,
        0x15, 0x47, 0xF1, 0x1A, 0x71,
        0x1D, 0x29, 0xC5, 0x89, 0x6F, 0xB7, 0x62, 0x0E, 0xAA, 0x18, 0xBE, 0x1B, 0x09, 0x83, 0x2C, 0x1A, 0x1B, 0x6E, 0x5A, 0xA0,
        0x52,
        0x3B, 0xD6, 0xB3, 0x29, 0xE3,
        0x2F, 0x84, 0x53, 0xD1, 0xA0, 0xED, 0x20, 0xFC, 0xB1, 0x5B, 0x6A, 0xCB, 0xBE, 0x39, 0x4A, 0x4C, 0x58, 0xCF, 0xB0, 0x54,
        0xBB,
        0x16
    ]

    func isDanaI() -> Bool {
        enhancedEncryption == EncryptionType.BLE_5.rawValue
    }

    func isDanaRS() -> Bool {
        enhancedEncryption == EncryptionType.RSv3.rawValue
    }

    func shouldDoSecondLevel() -> Bool {
        enhancedEncryption != EncryptionType.DEFAULT.rawValue
    }
