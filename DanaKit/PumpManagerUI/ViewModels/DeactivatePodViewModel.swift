...
public protocol PodDeactivater {
    func deactivatePod(completion: @escaping (DanaKitPumpManagerError?) -> ())
    func forgetPod(completion: @escaping () -> ())
}

extension DanaKitPumpManager: PodDeactivater {}
...
enum DeactivationError : LocalizedError {
    case OmnipodPumpManagerError(DanaKitPumpManagerError)
