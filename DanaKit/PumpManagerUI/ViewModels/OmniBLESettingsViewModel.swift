...
enum DashSettingsViewAlert {
    ...
    case syncTimeError(DanaKitPumpManagerError)
}
...
class DanaKitSettingsViewModel: ObservableObject {
    ...
    init(pumpManager: DanaKitPumpManager) {
...
extension DanaKitSettingsViewModel: PodStateObserver {
...
extension DanaKitSettingsViewModel: PumpManagerStatusObserver {
