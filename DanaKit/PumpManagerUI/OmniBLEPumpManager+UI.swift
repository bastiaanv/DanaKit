...
extension DanaKitPumpManager: PumpManagerUI {
    public static var onboardingImage: UIImage? {
        return UIImage(named: "Onboarding", in: Bundle(for: DanaKitSettingsViewModel.self), compatibleWith: nil)
    }
    ...
    public var smallImage: UIImage? {
        return UIImage(named: "Pod", in: Bundle(for: DanaKitSettingsViewModel.self), compatibleWith: nil)!
    }
...
public enum DanaKitStatusBadge: DeviceStatusBadge {
    case timeSyncNeeded
...
extension DanaKitPumpManager {
    ...
    public var pumpStatusBadge: DeviceStatusBadge? {
        if isClockOffset {
            return DanaKitStatusBadge.timeSyncNeeded
        } else {
            return nil
        }
    }
